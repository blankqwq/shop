        ...
        <div class="ps-container">
            <div class="ps-section__header mb-50">
                ...
                <ul class="ps-masonry__filter">
                    ...
                    <li><a href="#" data-filter=".nike">销量排序 <sup>低到高</sup></a></li>
                    <li><a href="#" data-filter=".nike">价格排序 <sup>低到高</sup></a></li>
                    <li><a href="#" data-filter=".nike">点击量排序 <sup>低到高</sup></a></li>
                                    ...
                                    <div class="ps-shoe mb-30">
                                        <div class="ps-shoe__thumbnail">
                                            ...
                                            <a class="ps-shoe__favorite"
                                               href="{{route('user.goods.favor',$goods->id)}}">
                                                <i class="ps-icon-heart"></i>
                                            </a>
                                            <img src="{{ url('storage/'.$goods->picture->url) }}" alt="">
                                            <a class="ps-shoe__overlay" href="{{route('goods.show',$goods->id)}}"></a>
                                        </div>
                                        <div class="ps-shoe__content">
                                            <div class="ps-shoe__variants">
                                                <div class="ps-shoe__variant normal">
                                                    @foreach($goods->pictures as $picture)
                                                        <img src="{{url('storage/'.$picture->url)}}" alt="">
                                                    @endforeach
                                                </div>
                                            ...
                                            <div class="ps-shoe__detail"><a class="ps-shoe__name"
                                                                            href="{{route('goods.show',$goods->id)}}">{{$goods->name}}</a>
                                                <p class="ps-shoe__categories">详细sku的信息<span class="ps-shoe__price">
						<del>£220</del>￥：{{$goods->sku->price}}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
